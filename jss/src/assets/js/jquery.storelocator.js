export function initStoreLocator($, window, document, undefined) {
	'use strict';
...
///	console.log("ASd")
	...
	var defaults = {
		...
		'bounceMarker'               : true,
		'catMarkers'                 : null,
		'dataLocation'               : 'assets/js/locations.json',
		'dataRaw'                    : null,
		'dataType'                   : 'json',
		'debug'                      : false,
		'defaultLat'                 : 45,
		...
		// Templates
		'infowindowTemplatePath'     : '/dist/my-angular-jss-app/browser/assets/js/templates/standard/infowindow-description.html',
		'listTemplatePath'           : '/dist/my-angular-jss-app/browser/assets/js/templates/standard/location-list-description.html',
		'KMLinfowindowTemplatePath'  : '/dist/my-angular-jss-app/browser/assets/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : '/dist/my-angular-jss-app/browser/assets/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
